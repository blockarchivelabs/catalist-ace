...
/// @title Catalist's Staking Module interface
interface IStakingModule {
    ...
    ///     costs were compensated to the Catalist by the node operator
    ...
    /// @notice Obtains deposit data to be used by StakingRouter to deposit to the Ace Deposit
    ///     contract
