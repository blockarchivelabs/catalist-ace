...
/**
 * @title CatalistLocator
 * @author mymphe
 * @notice Catalist service locator
 * @dev configuration is stored as public immutables to reduce gas consumption
 */
contract CatalistLocator is ICatalistLocator {
    struct Config {
    ...
    constructor(Config memory _config) {
        ...
        catalist = _assertNonZero(_config.catalist);
        oracleReportSanityChecker = _assertNonZero(
            _config.oracleReportSanityChecker
        );
        postTokenRebaseReceiver = _assertNonZero(
            _config.postTokenRebaseReceiver
        );
        ...
        validatorsExitBusOracle = _assertNonZero(
            _config.validatorsExitBusOracle
        );
