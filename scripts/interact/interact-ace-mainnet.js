...
async function main() {
  ...
  const catalist = await ethers.getContractAt('Catalist', '0x23bBA284db799Ca49381bEA734F1A55f14692f5c')
  const hashConsensus = await ethers.getContractAt('HashConsensus', '0x23b1f732c9B20CC09b8046931407ED2A883Cca82')
  const stakingRouter = await ethers.getContractAt('StakingRouter', '0x630941c45Cd3BC0B4FC843900C29c8432f4e935d')
  const accountingOracle = await ethers.getContractAt('AccountingOracle', '0xAC9d01Fa37A9492876Ead645D95011795e07bFEE')
  const withdrawalQueueERC721 = await ethers.getContractAt('WithdrawalQueueERC721', '0x9B6C9256f63a855f761A1ffEC792376346855406')
  const nodeOperatorRegistry = await ethers.getContractAt('NodeOperatorsRegistry', '0x1B731c8e3Cb936440F5298DBE548A7C9d765264C')
