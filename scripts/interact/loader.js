  ...
  const contracts = {
    DepositContract: {
      ...
      contract: await ethers.getContractAt(
        'DepositContract',
        addresses.chainSpec.depositContract,
      ),
    },
    Catalist: {
      name: 'Catalist',
      ...
      contract: await ethers.getContractAt(
        'Catalist',
        addresses['app:catalist'].proxy.address,
      ),
    ...
    StakingRouter: {
      ...
      contract: await ethers.getContractAt(
        'StakingRouter',
        addresses.stakingRouter.proxy.address,
      ),
      proxy: await ethers.getContractAt(
        'OssifiableProxy',
        addresses.stakingRouter.proxy.address,
    ...
    AccountingOracle: {
      ...
      contract: await ethers.getContractAt(
        'AccountingOracle',
        addresses.accountingOracle.proxy.address,
      ),
      proxy: await ethers.getContractAt(
        'OssifiableProxy',
        addresses.accountingOracle.proxy.address,
    ...
    DepositSecurityModule: {
      ...
      contract: await ethers.getContractAt(
        'DepositSecurityModule',
        addresses.depositSecurityModule.address,
      ),
    },
    CatalistLocator: {
      ...
      contract: await ethers.getContractAt(
        'CatalistLocator',
        addresses.catalistLocator.proxy.address,
      ),
      proxy: await ethers.getContractAt(
        'OssifiableProxy',
        addresses.catalistLocator.proxy.address,
    ...
    AragonKernel: {
      ...
      contract: await ethers.getContractAt(
        'Kernel',
        addresses['aragon-kernel'].proxy.address,
      ),
      proxy: await ethers.getContractAt(
        'KernelProxy',
        addresses['aragon-kernel'].proxy.address,
    ...
    AragonAcl: {
      ...
      contract: await ethers.getContractAt(
        'ACL',
        addresses['aragon-acl'].proxy.address,
      ),
      proxy: await ethers.getContractAt(
        'AppProxyUpgradeable',
        addresses['aragon-acl'].proxy.address,
    ...
    WbACE: {
      name: 'WbACE',
      address: addresses.wbACE.address,
      contract: await ethers.getContractAt('WbACE', addresses.wbACE.address),
    },
    OracleReportSanityChecker: {
      name: 'OracleReportSanityChecker',
      address: addresses.oracleReportSanityChecker.address,
      contract: await ethers.getContractAt(
        'OracleReportSanityChecker',
