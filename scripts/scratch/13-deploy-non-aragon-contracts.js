...
async function deployNewContracts({ web3, artifacts }) {
  ...
  //
  // === CatalistLocator: dummy invalid implementation ===
  //
  const locatorAddress = await deployBehindOssifiableProxy('catalistLocator', 'DummyEmptyContract', proxyContractsOwner, deployer, [], dummyContractAddress)
  logWideSplitter()
  ...
  await updateProxyImplementation("catalistLocator", "CatalistLocator", locatorAddress, proxyContractsOwner, [locatorConfig])
