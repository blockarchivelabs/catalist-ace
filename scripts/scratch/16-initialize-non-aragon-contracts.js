...
async function deployNewContracts({ web3, artifacts }) {
  ...
  const catalistLocatorAddress = state["catalistLocator"].proxy.address
  ...
  await makeTx(catalist, 'initialize', catalistInitArgs, { value: bootstrapInitBalance, from: DEPLOYER })
  logWideSplitter()
